...
The Flutter module lives at `AscendChat/` in the monorepo root, following the existing flat layout (`AscendAgent/`, `AudioScribe/`, `AscendWebSearch/`, etc.). The `pubspec.yaml` project name is `ascend_chat`.
