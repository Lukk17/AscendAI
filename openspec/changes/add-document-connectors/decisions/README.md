...
The records here decide what this change decides on top of that. They follow the format used by `AscendAgent/docs/architecture/decisions/`, and they carry the next free numbers in that directory's sequence at the time of writing.
