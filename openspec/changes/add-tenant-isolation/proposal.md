...
- **Documentation**: three architecture decision records drafted under `openspec/changes/add-tenant-isolation/decisions/` and placed into `AscendAgent/docs/architecture/decisions/` at implementation.
