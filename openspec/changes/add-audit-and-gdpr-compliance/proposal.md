...
- **Python services**: log-content audit of ascend-audio-scribe, ascend-web-hunter, AscendMemory, ascend-ocr against the redaction convention; fixes where leakage is found.
