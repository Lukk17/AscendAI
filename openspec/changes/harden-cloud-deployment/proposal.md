...
- **`ascend-scrapper.docker-compose.yaml`**: `ascend-web-hunter` loses `SYS_ADMIN`, gains seccomp profile + `init: true`; SearXNG limiter env flips; `ngrok-ascend-web-hunter` gains a profile; `ngrok/ngrok:3` pinned.
