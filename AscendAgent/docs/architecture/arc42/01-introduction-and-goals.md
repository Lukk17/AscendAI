...
AscendAI is a modular AI orchestration platform that routes user prompts to multiple AI providers (LM Studio, OpenAI,
Gemini, Anthropic, MiniMax), enriches them with RAG-based context, chat history, and semantic memory, and extends LLM
capabilities through MCP (Model Context Protocol) tool integrations.
