...
All significant architecture decisions are documented as Architecture Decision Records (ADRs):

| ADR | Decision | Status |
|---|---|---|
| [ADR-001](../decisions/ADR-001-multi-provider-ai.md) | Per-request AI provider selection via `ChatModelResolver` | Accepted |
