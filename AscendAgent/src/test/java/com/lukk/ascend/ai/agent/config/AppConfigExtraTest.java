...
/**
 * Extra branch coverage for AppConfig.initVectorStore CommandLineRunner:
 *  - collection already exists -> skip creation
 *  - collection does not exist -> create it
 *  - InterruptedException from listCollectionsAsync -> handled
 *  - ExecutionException from listCollectionsAsync -> handled
 *  - InterruptedException from createCollectionAsync -> handled
 *  - ExecutionException from createCollectionAsync -> handled
 */
@ExtendWith(MockitoExtension.class)
class AppConfigExtraTest {
    ...
    void initVectorStore_CollectionAlreadyExists_SkipsCreation() throws Exception {
        ...
        // listCollectionsAsync called, createCollectionAsync NOT called (collection exists)
