...
Each WeatherMCP e2e test run drops a filled-in copy of the matching `*-tasks.template.md` here, named
...
7. Fill **Input tokens** and **Output tokens** with your best estimate of the LLM tokens consumed across the run.
   WeatherMCP tests do not invoke any LLM — leave these as 0.
