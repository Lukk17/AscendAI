...
The Orchestrator needs to extend LLM capabilities with external tools (audio transcription, weather, web search). We need a standard protocol for tool discovery, invocation, and result handling.
