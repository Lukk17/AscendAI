...
./gradlew test --tests "com.lukk.ascend.ai.orchestrator.service.SomeTest"
...
**Package structure**: `com.lukk.ascend.ai.orchestrator`
...
- PostgreSQL (port 5432, database `ascend_ai`)
- Redis (port 6379) for chat history cache
- Qdrant (port 6333) for vector embeddings
- MinIO (port 9070) for document storage
