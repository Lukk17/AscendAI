...
`ascend-audio-scribe/e2e/fixtures/README.md` before continuing.
...
- `ascend-audio-scribe/e2e/fixtures/meeting-clip.wav`: 9.48 s mono audio at 24 kHz, spoken English line
