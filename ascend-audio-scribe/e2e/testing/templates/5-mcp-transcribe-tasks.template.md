...
- [ ] `ascend-audio-scribe/e2e/fixtures/meeting-clip.wav` exists on the host
...
- [ ] `curl.exe -sS -o NUL -w "%{http_code}\n" -X PUT -H "Content-Type: audio/mpeg" --data-binary "@ascend-audio-scribe/e2e/fixtures/meeting-clip.wav" "http://localhost:9070/e2e-fixtures/meeting-clip.wav"` prints `200`
