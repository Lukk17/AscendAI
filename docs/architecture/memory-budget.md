...
8192 (docling-serve) + 3072 (unstructured-api) + 12288 (ascend-paddle-ocr) + 3072 (ascend-agent) + 512 (ascend-memory) + 512 (weather-mcp) + 8192 (ascend-audio-scribe) + 512 (searxng) + 2048 (flaresolverr) + 256 (the scrapper's Redis) + 128 (ngrok) + 4096 (ascend-web-hunter) = 42880 MiB, which is 41.9 GiB across 12 services.
