...
Each ascend-ocr e2e test run drops a filled-in copy of the matching `*-tasks.template.md` here, named
...
2026-05-30T01-15-00_2-ocr-english-tasks.md
2026-05-30T01-15-00_3-ocr-polish-tasks.md
```
...
7. Fill **Input tokens** and **Output tokens** with your best estimate of the LLM tokens consumed across the run.
   ascend-ocr tests do not invoke any LLM — leave these as 0.
