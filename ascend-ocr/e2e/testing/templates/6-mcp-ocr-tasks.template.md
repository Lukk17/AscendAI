...
- [ ] `ascend-ocr/e2e/fixtures/argent-saga-chronicles-page1.png` exists on the host
...
- [ ] `curl.exe -sS -o NUL -w "%{http_code}\n" -X PUT -H "Content-Type: image/png" --data-binary "@ascend-ocr/e2e/fixtures/argent-saga-chronicles-page1.png" "http://localhost:9070/e2e-fixtures/argent-saga-chronicles-page1.png"` prints `200`
