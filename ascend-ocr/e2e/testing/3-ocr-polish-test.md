...
```powershell
Test-Path ascend-ocr/e2e/fixtures/argent-saga-chronicles-page1-polish.png
```

Expect `True`. If missing, generate it per [`ascend-ocr/e2e/fixtures/README.md`](../fixtures/README.md) using a font
...
- [`ascend-ocr/e2e/fixtures/argent-saga-chronicles-page1-polish.png`](../fixtures/argent-saga-chronicles-page1-polish.png) — black `Saga Świetlna / Aenaria / Eklipsą` text
