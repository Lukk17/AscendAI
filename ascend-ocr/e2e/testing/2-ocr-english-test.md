...
```powershell
Test-Path ascend-ocr/e2e/fixtures/argent-saga-chronicles-page1.png
```

Expect `True`. If missing, generate it per [`ascend-ocr/e2e/fixtures/README.md`](../fixtures/README.md).
...
- [`ascend-ocr/e2e/fixtures/argent-saga-chronicles-page1.png`](../fixtures/argent-saga-chronicles-page1.png) — black `Argent Saga / Aenaria / Halen Veyr` text on
...
See [`ascend-ocr/e2e/testing/README.md`](README.md) "Execution order" section for the canonical fan-out shape.
