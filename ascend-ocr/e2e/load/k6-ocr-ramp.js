...
//
// Usage:
//   k6 run --vus 80 ascend-ocr/e2e/load/k6-ocr-ramp.js
// or with the inline ramp:
//   k6 run ascend-ocr/e2e/load/k6-ocr-ramp.js
//
...
const fixturePath = __ENV.FIXTURE_PATH || './ascend-ocr/e2e/fixtures/argent-saga-chronicles-page1.png';
