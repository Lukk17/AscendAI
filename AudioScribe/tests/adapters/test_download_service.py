...
@pytest.mark.asyncio
async def test_download_file_uri_success(tmp_path: Any) -> None:
    # // given
...
@pytest.mark.asyncio
async def test_download_file_uri_not_found() -> None:
    # // given
...
@pytest.mark.asyncio
async def test_download_http_uri_success() -> None:
    # // given
...
@pytest.mark.asyncio
async def test_download_http_uri_404() -> None:
    # // given
    uri = "http://example.com/audio.mp3"
    mock_response = AsyncMock()
...
@pytest.mark.asyncio
async def test_download_http_uri_500() -> None:
    # // given
    uri = "http://example.com/error.mp3"
    mock_response = AsyncMock()
    ...
    # // when/then
    with patch("aiohttp.ClientSession", return_value=mock_session):
        with pytest.raises(ValueError, match="Failed to download from .* 500"):
            await download_to_temp_async(uri)


@pytest.mark.asyncio
async def test_download_http_uri_401() -> None:
    # // given
...
@pytest.mark.asyncio
async def test_download_http_uri_403() -> None:
    # // given
...
@pytest.mark.asyncio
async def test_download_unsupported_scheme() -> None:
    # // given
