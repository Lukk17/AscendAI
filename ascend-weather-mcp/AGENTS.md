...
ascend-weather-mcp is a standalone MCP server built with Spring AI that provides weather data to the AscendAgent via the Model Context Protocol. It uses SSE (Server-Sent Events) for communication.
