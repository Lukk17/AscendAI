...
Each ascend-weather-mcp e2e test run drops a filled-in copy of the matching `*-tasks.template.md` here, named
...
2026-05-30T01-15-00_2-current-structured-contract-tasks.md
2026-05-30T01-15-00_3-current-city-not-found-tasks.md
```
...
7. Fill **Input tokens** and **Output tokens** with your best estimate of the LLM tokens consumed across the run.
   ascend-weather-mcp tests do not invoke any LLM — leave these as 0.
