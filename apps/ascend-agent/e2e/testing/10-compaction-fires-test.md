...
```bash
ls apps/ascend-agent/e2e/fixtures/compaction-seeds/seed-compaction-fires.sql apps/ascend-agent/e2e/fixtures/compaction-seeds/seed-compaction-fires.redis
```
...
```bash
docker exec -i postgres psql -U postgres -d ascend_ai < apps/ascend-agent/e2e/fixtures/compaction-seeds/seed-compaction-fires.sql
```
...
```bash
docker cp apps/ascend-agent/e2e/fixtures/compaction-seeds/seed-compaction-fires.redis redis:/tmp/seed-compaction-fires.redis
```
...
- `apps/ascend-agent/e2e/fixtures/compaction-seeds/seed-compaction-fires.sql`
- `apps/ascend-agent/e2e/fixtures/compaction-seeds/seed-compaction-fires.redis`
