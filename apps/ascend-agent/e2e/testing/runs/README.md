...
1. Specs (`apps/ascend-agent/e2e/testing/<N>-<feature>-test.md`) are **immutable** between runs. The runner never edits
   them.
2. Templates (`apps/ascend-agent/e2e/testing/templates/<N>-<feature>-tasks.template.md`) are also **immutable**. They
