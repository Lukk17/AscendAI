...
```bash
ls apps/ascend-agent/e2e/fixtures/dedup-pierogi-helena.md apps/ascend-agent/e2e/fixtures/dedup-pierogi-grandma.md
```
...
- `apps/ascend-agent/e2e/fixtures/dedup-pierogi-helena.md`
- `apps/ascend-agent/e2e/fixtures/dedup-pierogi-grandma.md`
