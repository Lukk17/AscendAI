...
```bash
ls apps/ascend-agent/e2e/fixtures/argent-saga-chronicle.pdf
```
...
- `apps/ascend-agent/e2e/fixtures/argent-saga-chronicle.pdf` (with the `.md` source alongside for regeneration).
