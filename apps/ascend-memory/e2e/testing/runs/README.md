...
Each AscendMemory e2e test run drops a filled-in copy of the matching `*-tasks.template.md` here, named
...
2026-05-30T01-15-00_2-insert-and-search-tasks.md
2026-05-30T01-15-00_3-wipe-user-scope-tasks.md
```
...
7. Fill **Input tokens** and **Output tokens** with your best estimate of the LLM tokens consumed across the run.
   AscendMemory tests do not directly invoke a chat LLM; the embedding backend may report token counts if it surfaces
   them, otherwise leave these as 0.
