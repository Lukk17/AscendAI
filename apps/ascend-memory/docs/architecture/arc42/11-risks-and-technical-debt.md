...
| No auth on REST endpoints | Any caller with network access can read or wipe any user's memories. Intended to be addressed at the ascend-ai-agent or API gateway level. | Medium |
