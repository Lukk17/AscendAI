...
- **Cons**: Not already deployed in the platform. ascend-ai-agent's RAG pipeline uses Qdrant; running two vector stores
...
- Memory storage reuses the same Qdrant instance as ascend-ai-agent's RAG pipeline.
