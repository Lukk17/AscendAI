...
Each ascend-audio-scribe e2e test run drops a filled-in copy of the matching `*-tasks.template.md` here, named
...
7. Fill **Input tokens** and **Output tokens** with your best estimate of the LLM tokens consumed across the run.
   ascend-audio-scribe itself invokes no LLM directly, but OpenAI Whisper and Hugging Face inference do consume billable
