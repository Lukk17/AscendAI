...
```bash
ls apps/ascend-ai-agent/e2e/fixtures/markdown-canary.md apps/ascend-ai-agent/e2e/fixtures/banana-price-poland.pdf apps/ascend-ai-agent/e2e/fixtures/pierogi-recipe.docx
```
...
- `apps/ascend-ai-agent/e2e/fixtures/markdown-canary.md`
- `apps/ascend-ai-agent/e2e/fixtures/banana-price-poland.pdf`
- `apps/ascend-ai-agent/e2e/fixtures/pierogi-recipe.docx`
