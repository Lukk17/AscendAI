...
boxes. The service is consumed by [ascend-ai-agent](../ascend-ai-agent/AGENTS.md), which routes prompts that need text
...
| [tests/contract/test_ascend_ai_agent_pact_stub.py](tests/contract/test_ascend_ai_agent_pact_stub.py)             | Pact provider verification stub           |
