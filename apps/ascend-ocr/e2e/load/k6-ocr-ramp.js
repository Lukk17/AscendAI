...
// Runs against a fixture image; expects the host-side ascend-ocr on :7022.
//
// Usage:
//   k6 run --vus 80 apps/ascend-ocr/e2e/load/k6-ocr-ramp.js
// or with the inline ramp:
//   k6 run apps/ascend-ocr/e2e/load/k6-ocr-ramp.js
//
...
const fixturePath = __ENV.FIXTURE_PATH || './apps/ascend-ocr/e2e/fixtures/argent-saga-chronicles-page1.png';
