...
class Settings(BaseSettings):
    ...
    # ceiling (see ascend-ocr/openspec/.../design.md, "the measured memory model"), so
    ...
    OCR_SCRATCH_DIR: str = Field(default_factory=lambda: str(Path(tempfile.gettempdir()) / "ascend-ocr-scratch"))
