...
APP_LOG_FORMAT: str = (
    "%(log_color)s[AscendOcr] %(asctime)s - %(levelname)s - %(module)-18s%(reset)s >> %(log_color)s%(message)s"
)

UVICORN_LOG_FORMAT: str = "%(log_color)s[AscendOcr] %(asctime)s - %(levelname)s - %(message)s"
