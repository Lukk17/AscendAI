...
- [../tests/contract/test_ascend_ai_agent_pact_stub.py](../tests/contract/test_ascend_ai_agent_pact_stub.py) for the
  consumer-driven contract stub between ascend-ai-agent and ascend-ocr
